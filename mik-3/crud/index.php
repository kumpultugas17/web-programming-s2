            ...
            <div class="card text-left">
              ...
              <div class="card-body">
                <div class="row alert alert-success">
                  ...
                  <p class="fs-5">Selamat datang di Halaman Admin! <br> Anda dapat mengelola data di halaman ini. </p>
                </div>
                <!-- ========================= -->
                <div class="row">
                        ...
                        <div class="row no-gutters align-item-center">
                          <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 fw-bold text-gray-800">
                              ...
                              echo mysqli_num_rows($query_beli);
                              ?>
                            </div>
                          </div>
                        </div>
...
<!-- untuk menampilkan Alert Login Sukses -->

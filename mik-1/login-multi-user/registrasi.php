...
if (isset($_POST['btn_registrasi'])) {
  ...
  // menginsert ke tabel registrasi
  $query_reg = $koneksi->query("INSERT INTO registrasi (nama_lengkap, tempat_lahir, tanggal_lahir, alamat, telp, email) VALUES ('$nama_lengkap', '$tempat_lahir', '$tanggal_lahir', '$alamat', '$telp', '$email')");

  // menginsert ke tabel login
  $query_log = $koneksi->query("INSERT INTO login (username, email, password, level) VALUES ('$nama_lengkap', '$email', '$password', 1)");
